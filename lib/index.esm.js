...
var SEMITONES_LENGTH = NOTE_LIST.length;
/**
 * 品柱数量
 */
var GRADE_NUMS = 16;
...
var degreeMap = new Map([
    ...
    [
        ...
        [
            { interval: 0, tag: 'Ⅰ', scale: 'Tonic', roll: 'Do' },
            { interval: 2, tag: 'Ⅱ', scale: 'Supertonic', roll: 'Re' },
            { interval: 3, tag: 'Ⅲ', scale: 'Mediant', roll: 'Mi' },
            { interval: 5, tag: 'Ⅳ', scale: 'Subdominant', roll: 'Fa' },
            { interval: 7, tag: 'Ⅴ', scale: 'Dominant', roll: 'So' },
            { interval: 8, tag: 'Ⅵ', scale: 'Submediant', roll: 'Le' },
...
var transScaleDegree = function (_a) {
    var _b = _a.mode, mode = _b === void 0 ? 'major' : _b, _c = _a.scale, scale = _c === void 0 ? 'C' : _c, _d = _a.chordType, chordType = _d === void 0 ? 3 : _d;
    ...
    // 根据大调顺阶degreeArr转换大调
    var degrees = degreeArr.map(function (degree, index) {
...
var transBoard = function (zeroTones, GradeLength, baseLevel) {
    ...
    if (baseLevel === void 0) { baseLevel = 2; }
...
export { DEFAULT_TUNE, FINGER_GRADE_NUMS, GRADE_NUMS, INTERVAL_FALLING_LIST, INTERVAL_LIST, NOTE_FALLING_LIST, NOTE_LIST, NOTE_SORT, SEMITONES_LENGTH, STRING_NUMS, chordDegreeMap, chordMap, degreeMap, transBoard, transChord, transChordTaps, transChordType, transFifthsCircle, transNote, transScaleDegree, transTone };
