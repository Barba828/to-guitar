...
var transChordTaps = function (tones, board, fingerSpan) {
    ...
    // 获取所有根音下的和弦列表
    roots.splice(1).forEach(function (point) {
...
export { Board, DEFAULT_LEVEL, DEFAULT_TUNE, FINGER_GRADE_NUMS, GRADE_NUMS, INTERVAL_FALLING_LIST, INTERVAL_LIST, MODE_LIST, NOTE_FALLING_LIST, NOTE_LIST, NOTE_SORT, STRING_NUMS, chordDegreeMap, chordMap, defaultOptions as defaultBoardOptions, degreeMap, transBoard, transChord, transChordTaps, transChordType, transFifthsCircle, transNote, transScaleDegree, transTone };

if(typeof window !== 'undefined') {
  window._Dry_VERSION_ = '0.0.9'
}
